...
struct Expression
{
    ...
    inline Real operator()(Args&&... x) const
    {
...
template<size_t Idx>
struct Variable : public Expression<Variable<Idx>>
{
...
template <typename T>
struct is_variable_trait : std::false_type {};
...
template<double Val>
struct Constant : public Expression<Constant<Val>>
{
...
template<int Val>
struct Integer : public Expression<Integer<Val>>
{
...
template <typename T>
struct is_constant_trait : std::false_type{};
...
template <typename T>
struct is_integer_trait : std::false_type{};
